...
@register.inclusion_tag('templatetags/crispy.html')
def crispy(form):
    return {"form": form}

@register.inclusion_tag('templatetags/crispy_inline.html')
def crispy_inline(form):
    return {"form": form}
...
def active(request, pattern):
    import re
    if re.search(pattern, request.get('path')):
        return 'active'
    return ''
