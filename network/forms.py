...
class NetworkForm(forms.ModelForm):
    ...
    duration = forms.FloatField(required=True,
        ...
        widget = forms.TextInput(attrs = {
            ...
            'class': 'form-control required number positive nonzero min 1000 max 5000'}))
...
class LinkForm(forms.Form):
    ...
    delay = forms.FloatField(required = True, initial = 1., label = "Delay (ms)",
        widget = forms.TextInput(attrs = {'placeholder': '1','class': 'form-control number positive nonzero min 1 max 10'}))
...
#            'placeholder': 'V_m',
            'placeholder': '-70.0',
            'class': 'form-control number neuron hh_psc_alpha iaf_neuron iaf_cond_alpha iaf_psc_alpha'}))
...
#            'placeholder': 'g_L',
            'placeholder': '30.0',
            'class': 'form-control number positive nonzero neuron hh_psc_alpha'}))
...
#            'placeholder': 'E_Na',
            'placeholder': '50.0',
            'class': 'form-control number neuron hh_psc_alpha'}))
...
#            'placeholder': 'tau_m',
            'placeholder': '10.0',
            'class': 'form-control number positive nonzero neuron iaf_neuron'}))
...
#            'placeholder': 't_ref',
            'placeholder': '2.0',
            'class': 'form-control number positive nonzero neuron iaf_neuron iaf_cond_alpha iaf_psc_alpha'}))
...
#            'placeholder': 'V_th',
            'placeholder': '-55.0',
            'class': 'form-control number neuron iaf_neuron iaf_cond_alpha iaf_psc_alpha'}))
...
#            'placeholder': 'E_ex',
            'placeholder': '0.0',
            'class': 'form-control number neuron iaf_cond_alpha'}))
...
#            'placeholder': 'tau_syn_ex',
            'placeholder': '0.2',
            'class': 'form-control number positive nonzero neuron iaf_cond_alpha iaf_psc_alpha'}))
...
#            'placeholder': 'amplitude',
            'placeholder': '0.0',
            'class': 'form-control required number positive input ac_generator dc_generator'}))
...
#            'placeholder': 'frequency',
            'placeholder': '0.0',
            'class': 'form-control number positive input ac_generator'}))
...
#            'placeholder': 'phase',
            'placeholder': '0.0',
            'class': 'form-control number positive limit max 360 input ac_generator'}))
...
#            'placeholder': 'mean',
            'placeholder': '0.0',
            'class': 'form-control number positive input noise_generator'}))
...
#            'placeholder': 'dt',
            'placeholder': '1.0',
            'class': 'form-control number positive nonzero input noise_generator'}))
...
#            'placeholder': 'rate',
            'placeholder': '0.0',
            'class': 'form-control required number positive input poisson_generator'}))
...
#            'placeholder': 'spike_times',
            'placeholder': '',
            'class': 'form-control required number list positive nonzero input spike_generator'}))
...
#            'placeholder': 'start',
            'placeholder': '0.0',
            'class': 'form-control number positive input ac_generator dc_generator poisson_generator spike_generator'}))
...
#            'placeholder': 'stop',
            'placeholder': 'inf',
            'class': 'form-control number positive nonzero input ac_generator dc_generator poisson_generator spike_generator'}))
...
#            'placeholder': 'step',
            'placeholder': '',
            'class': 'form-control number positive input spike_generator'}))
